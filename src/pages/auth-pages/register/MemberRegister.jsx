...
import { useRegisterGymMember, useLogin } from "@/hooks/useAuth";

export default function MemberRegister({ onBack }) {
  ...
  const { mutate: register, isPending } = useRegisterGymMember();
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#E1E5F1] flex items-center justify-center p-4 overflow-hidden font-sans">
      ...
      <Card className="relative z-10 w-full max-w-[550px] rounded-[32px] border-white/20 bg-black/80 backdrop-blur-2xl shadow-2xl text-white">
        <CardHeader className="pt-8 px-8 pb-4">
          ...
          <CardDescription className="text-white/50 font-medium pt-2">
            Create your member account and start transforming yourself.
          </CardDescription>
        </CardHeader>
